...
/**
 * Created by Ali on 05/28/2016.
 */
public class PersistantCookieStoreExtended implements CookieStore
{

    private static final String LOG_TAG = "PersistantCookieStoreExtended";
    ...
    /**
     * Construct a persistent cookie store extended.
     *
     * @param context Context to attach cookie store to
     */
    public PersistantCookieStoreExtended(Context context,String fileName)
    {
        cookiePrefs = context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
